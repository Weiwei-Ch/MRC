...
def evaluate(args, model_path1, model1, model2, model3, tokenizer, prefix=""):
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        for i, feature_index in enumerate(feature_indices):
            ...
            start_logits = w1*start_logits1 + w2*start_logits2 + w3*start_logits3
            end_logits = w1*end_logits1 + w2*end_logits2 + w3*end_logits3
...
def main():
    ...
    model_path1 = "roberta_large_adv_output2/DuReader/checkpoint-3000/"
    model_path2 = "roberta_large_brightmart_output/DuReader/checkpoint-3000/"
    model_path3 = "roberta_large_adv_output/DuReader/checkpoint-3000/"
    ...
    # Evaluate
    result = evaluate(args, model_path1, model1, model2, model3, tokenizer, prefix="")
